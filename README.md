...
Arxiv: [https://arxiv.org/abs/2505.19203](https://arxiv.org/abs/2505.19203)
...
- datasplit_dev.csv shows the detailed metadata for **Real Data**, including filename, scene label, event label, caption, etc.
